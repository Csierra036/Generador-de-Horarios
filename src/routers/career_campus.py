...
router = APIRouter(prefix="/career_campus", tags=["Career Campus"])
...
async def update_career_campus(
    career_campus_id: int,
    career_campus_request: CreateCareerCampusRequest,
